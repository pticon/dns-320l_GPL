...
TERMINFO="/home/roy/DNS-345_GPL/packages/ncurses-5.7/_install/share/terminfo"

MKDIRS="sh /home/roy/DNS-345_GPL/packages/ncurses-5.7/mkdirs.sh"
...
*.[0-9]*)
	...
	if test ! -f /home/roy/DNS-345_GPL/packages/ncurses-5.7/man_alias.sed ; then
cat >>/home/roy/DNS-345_GPL/packages/ncurses-5.7/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TPUT@,tput,
CF_EOF2
		echo "...made /home/roy/DNS-345_GPL/packages/ncurses-5.7/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /home/roy/DNS-345_GPL/packages/ncurses-5.7/man_alias.sed | sort -u`
	...
	sed	-f /home/roy/DNS-345_GPL/packages/ncurses-5.7/man_alias.sed \
		< $i >$TMP
