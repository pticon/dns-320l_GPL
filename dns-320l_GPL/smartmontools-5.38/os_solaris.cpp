...
static const char *filenameandversion="$Id: os_solaris.cpp,v 1.1.1.1 2009/10/09 02:53:13 jack Exp $";

const char *os_XXXX_c_cvsid="$Id: os_solaris.cpp,v 1.1.1.1 2009/10/09 02:53:13 jack Exp $" \
