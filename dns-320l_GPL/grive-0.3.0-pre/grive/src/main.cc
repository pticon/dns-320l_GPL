...
const std::string client_id		= "7942285329-bmvh8okjaej3m758d3p6oujm2aj1uf1k.apps.googleusercontent.com" ;
const std::string client_secret	= "Q3SUBe_H4TTNHljYCmRMEaWT" ;
...
int Main( int argc, char **argv )
{
	...
	desc.add_options()
		...
		( "upload,u",	"Force grive to always upload a file from local to google drive ")
		( "force,f",	"Force grive to always download a file from Google Drive "
						"instead of uploading it." )
		( "quota,q",	"Request quota ")
