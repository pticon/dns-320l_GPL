...
private :
	...
	Val UploadMetadata( Resource *res );
	bool UploadLargeFile( Resource *res );
	bool UploadSmallFile( Resource *res );
	void DeleteRemote( std::string etag, std::string selfHref );
