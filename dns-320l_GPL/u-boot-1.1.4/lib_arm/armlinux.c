...
#define LOAD_DEFAULT_RAMDISK_ADDR	0xD00000
extern char load_kernel_error_flag;  //alpha.jack.20090317+
#if defined(MV78200) && defined(DUAL_OS_SHARED_MEM_78200)
...
//alpha.jack.20090317+
		if ( load_kernel_error_flag == 0 )
			...
			addr = LOAD_DEFAULT_RAMDISK_ADDR;
