...
#else
#define CONFIG_IDENT_STRING	" Marvell version: 3.6.0.DNS-320L.01" //alpha.jack.20110511+"
#endif /* MV_TINY_IMAGE */
...
#define CONFIG_IPADDR		2.66.66.201
#define CONFIG_SERVERIP		2.66.66.32
...
/* auto boot*/
#define CONFIG_BOOTDELAY	1		/* by default no autoboot */ //alpha.jack.20110511+

#if (CONFIG_BOOTDELAY >= 0)
#define CONFIG_ROOTPATH	/srv/ubuntu
#ifdef RAMDISK
/*alpha.jack*/
//#define CONFIG_BOOTCOMMAND      "nand read.e 0xa00000 0x500000 0x500000;nand read.e 0xf00000 0xa00000 0x400000;bootm 0xa00000 0xf00000"       /* autoboot command     */
#define CONFIG_BOOTCOMMAND      "nand read.e 0xa00000 0x100000 0x300000;nand read.e 0xf00000 0x600000 0x300000;bootm 0xa00000 0xf00000"       /* autoboot command     */
#define CONFIG_BOOTARGS "root=/dev/ram console=ttyS0,115200 :::DB88FXX81:egiga0:none"	/* RAMdisk */ 
#endif
