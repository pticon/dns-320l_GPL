...
#define LOAD_DEFAULT_KERNEL_ADDR	0xa00000  //alpha.jack.20090317+
char load_kernel_error_flag=0;	//alpha.jack.20090317+
...
//alpah.jack.20090317+	
	load_kernel_error_flag = 0;
load_default_kenel:	
	if ( load_kernel_error_flag == 1)
	{
		*((ulong  *)(0xf1010008)) = 0x1100;
		*((ulong  *)(0xf1010108)) = 0x00C00000; /* detect ramdisk broken and blinking HD led */
		run_command("nand read.e 0xa00000 0x6f00800 0x500000;",0);
	}
//alpha.jack.20090317 end
...
//alpha.jack.20090317+			
		...
		return 1;
			...
			{
				load_kernel_error_flag = 1;
				addr = LOAD_DEFAULT_KERNEL_ADDR;
				goto load_default_kenel;
			}
//alpha.jack.20090317 end	
	    }
	}
