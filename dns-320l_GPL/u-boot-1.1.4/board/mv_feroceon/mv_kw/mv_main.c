...
//	mvBoardDebugLed(3);  //alpha.jack.20110511-
...
//	mvBoardDebugLed(4); //alpha.jack.20110511-
	return 0;
}
...
#define CONFIG_BOOTCOMMAND_1      "nand read.e 0xa00000 0x100000 0x300000;nand read.e 0xf00000 0x600000 0x300000;bootm 0xa00000 0xf00000"       /* autoboot command     */
	    setenv("bootcmd",CONFIG_BOOTCOMMAND_1);
...
//	mvBoardDebugLed(0); //alpha.jack.20110511-
	return 0;
}
#endif
...
//	mvBoardDebugLed(5); //alpha.jack.20110511-
...
//	mvBoardDebugLed(6); //alpha.jack.20110511-

//	mvBoardDebugLed(7); //alpha.jack.20110511-
