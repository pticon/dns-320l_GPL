...
extern int ALL_HDD_LED_RED_BLINK();
extern int USB_LED_RED_BLINK();
#endif
...
load_default_kernel:	
	...
	{
		printf ("### Loading Rescure Firmware ###\n");		
		run_command("nand read.e 0xa00000 0xDD00800 0x500000;",0);
		//ALL_HDD_LED_RED_BLINK();
		USB_LED_RED_BLINK();
	}
