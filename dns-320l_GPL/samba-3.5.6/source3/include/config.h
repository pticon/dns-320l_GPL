...
#define STRING_STATIC_MODULES " pdb_ldap pdb_smbpasswd pdb_tdbsam pdb_wbc_sam rpc_lsarpc rpc_winreg rpc_initshutdown rpc_dssetup rpc_wkssvc rpc_svcctl rpc_ntsvcs rpc_netlogon rpc_netdfs rpc_srvsvc rpc_spoolss rpc_eventlog rpc_samr idmap_ldap idmap_tdb idmap_passdb idmap_nss nss_info_template auth_sam auth_unix auth_winbind auth_wbc auth_server auth_domain auth_builtin auth_netlogond vfs_default"
...
/* Decl of Static init functions */
#define static_decl_pdb extern NTSTATUS pdb_ldap_init(void); extern NTSTATUS pdb_smbpasswd_init(void); extern NTSTATUS pdb_tdbsam_init(void); extern NTSTATUS pdb_wbc_sam_init(void);
...
/* Static init functions */
#define static_init_pdb {  pdb_ldap_init();  pdb_smbpasswd_init();  pdb_tdbsam_init();  pdb_wbc_sam_init();}
