...
static struct APP0infotype {
		...
		BYTE thumbnwidth; // 0
		BYTE thumbnheight; // 0
} APP0info={0xFFE0,16,"JFIF\0",1,1,0,1,1,0,0};
...
//+Vincent10052005
typedef struct { BYTE B,G,R,RESERVE; } PALETTERGB;
#define BITPERPIX_32	32	//32 bits per pixel
#define BITPERPIX_24	24	//24 bits per pixel
#define BITPERPIX_8		8	//256 colors
#define BITPERPIX_4		4	//16 colors
#define BITPERPIX_1		1	//2 colors
//Vincent10052005+
