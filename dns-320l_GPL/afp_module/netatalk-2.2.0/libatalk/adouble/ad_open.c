 ...
 */
#if 0 //ALPHA_CUSTOMIZE /* Bing modify 2010/06/23 */
...
{
#if 0  //ALPHA_CUSTOMIZE /* Bing modified 2010/06/23 */
    if (*mode == 0) {
        return -1;
    }
...
#if 1  //ALPHA_CUSTOMIZE /* +Bing add for changing create mode 2010/06/23 */
