...
__env_create_reply *
__db_env_create_4007_svc(msg, req)
...
__db_env_cdsgroup_begin_4007_svc(msg, req)
...
__env_close_reply *
__db_env_close_4007_svc(msg, req)
	__env_close_msg *msg;
	struct svc_req *req;
{
...
__db_env_dbremove_4007_svc(msg, req)
...
__db_env_dbrename_4007_svc(msg, req)
...
__db_env_get_cachesize_4007_svc(msg, req)
...
__db_env_get_encrypt_flags_4007_svc(msg, req)
...
__db_env_get_flags_4007_svc(msg, req)
...
__db_env_get_home_4007_svc(msg, req)
...
__db_env_get_open_flags_4007_svc(msg, req)
...
__env_open_reply *
__db_env_open_4007_svc(msg, req)
	__env_open_msg *msg;
	struct svc_req *req;
{
...
__env_remove_reply *
__db_env_remove_4007_svc(msg, req)
...
__db_env_set_cachesize_4007_svc(msg, req)
...
__db_env_set_encrypt_4007_svc(msg, req)
...
__db_env_set_flags_4007_svc(msg, req)
...
__db_env_txn_begin_4007_svc(msg, req)
...
__db_env_txn_recover_4007_svc(msg, req)
...
__db_create_reply *
__db_db_create_4007_svc(msg, req)
	__db_create_msg *msg;
	struct svc_req *req;
{
...
__db_db_associate_4007_svc(msg, req)
...
__db_close_reply *
__db_db_close_4007_svc(msg, req)
	__db_close_msg *msg;
	struct svc_req *req;
{
...
__db_cursor_reply *
__db_db_cursor_4007_svc(msg, req)
	__db_cursor_msg *msg;
	struct svc_req *req;
{
...
__db_db_get_bt_minkey_4007_svc(msg, req)
...
__db_db_get_dbname_4007_svc(msg, req)
...
__db_db_get_encrypt_flags_4007_svc(msg, req)
...
__db_db_get_flags_4007_svc(msg, req)
...
__db_db_get_h_ffactor_4007_svc(msg, req)
...
__db_db_get_h_nelem_4007_svc(msg, req)
...
__db_db_get_lorder_4007_svc(msg, req)
...
__db_db_get_open_flags_4007_svc(msg, req)
...
__db_db_get_pagesize_4007_svc(msg, req)
...
__db_db_get_priority_4007_svc(msg, req)
...
__db_db_get_q_extentsize_4007_svc(msg, req)
...
__db_db_get_re_delim_4007_svc(msg, req)
...
__db_db_get_re_len_4007_svc(msg, req)
...
__db_db_get_re_pad_4007_svc(msg, req)
...
__db_db_key_range_4007_svc(msg, req)
...
__db_remove_reply *
__db_db_remove_4007_svc(msg, req)
	__db_remove_msg *msg;
	struct svc_req *req;
{
...
__db_rename_reply *
__db_db_rename_4007_svc(msg, req)
	__db_rename_msg *msg;
	struct svc_req *req;
{
...
__db_db_set_bt_minkey_4007_svc(msg, req)
...
__db_db_set_encrypt_4007_svc(msg, req)
...
__db_db_set_flags_4007_svc(msg, req)
...
__db_db_set_h_ffactor_4007_svc(msg, req)
...
__db_db_set_h_nelem_4007_svc(msg, req)
...
__db_db_set_lorder_4007_svc(msg, req)
...
__db_db_set_pagesize_4007_svc(msg, req)
...
__db_db_set_priority_4007_svc(msg, req)
...
__db_db_set_q_extentsize_4007_svc(msg, req)
...
__db_db_set_re_delim_4007_svc(msg, req)
...
__db_db_set_re_len_4007_svc(msg, req)
...
__db_db_set_re_pad_4007_svc(msg, req)
...
__db_truncate_reply *
__db_db_truncate_4007_svc(msg, req)
...
__dbc_close_reply *
__db_dbc_close_4007_svc(msg, req)
	__dbc_close_msg *msg;
	struct svc_req *req;
{
...
__dbc_count_reply *
__db_dbc_count_4007_svc(msg, req)
	__dbc_count_msg *msg;
	struct svc_req *req;
{
...
__db_dbc_get_priority_4007_svc(msg, req)
...
__dbc_pget_reply *
__db_dbc_pget_4007_svc(msg, req)
	__dbc_pget_msg *msg;
	struct svc_req *req;
{
...
__db_dbc_set_priority_4007_svc(msg, req)
...
__txn_abort_reply *
__db_txn_abort_4007_svc(msg, req)
	__txn_abort_msg *msg;
	struct svc_req *req;
{
...
__txn_commit_reply *
__db_txn_commit_4007_svc(msg, req)
...
__txn_discard_reply *
__db_txn_discard_4007_svc(msg, req)
...
__txn_prepare_reply *
__db_txn_prepare_4007_svc(msg, req)
