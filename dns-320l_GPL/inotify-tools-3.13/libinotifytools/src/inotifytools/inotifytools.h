...
#define ALPHA_CUSTOMIZE_INOTIFYTOOLS
#include <stdio.h>

#if 1 //royc2011/11/11
int inotifytools_remove_watch_by_wd_delete( int wd );
#endif
...
int inotifytools_watch_recursively_with_exclude( char const * path,
                                                 ...
                                                 // [UH]
#ifdef ALPHA_CUSTOMIZE_INOTIFYTOOLS
int inotifytools_remove_watch_recursive_by_filename( char const * filename);
#endif
