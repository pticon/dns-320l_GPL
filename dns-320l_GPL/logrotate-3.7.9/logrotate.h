...
enum CRITERIUM{ ROT_DAYS, ROT_WEEKLY, ROT_MONTHLY, ROT_YEARLY, ROT_SIZE,
	ROT_FORCE, ROT_TWO_MONTHLY, ROT_THREE_MONTHLY, ROT_SIX_MONTHLY, ROT_LOGCOUNT};
#endif
...
struct logInfo {
	...
	enum CRITERIUM criterium2;
	enum CRITERIUM criterium3;
#else
