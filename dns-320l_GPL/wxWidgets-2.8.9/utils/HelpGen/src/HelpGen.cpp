...
// Modified by:
// Created:     06/01/99
// RCS-ID:      $Id: HelpGen.cpp,v 1.1.1.1 2009/10/09 02:59:40 jack Exp $
// Copyright:   (c) 1999 VZ
...
static const wxString GetVersionString()
{
    wxString version = "$Revision: 1.1.1.1 $";
    wxRegEx("^\\$Revision: 1.1.1.1 $$").ReplaceFirst(&version, "\\1");
    return version;
}

/*
   $Log: HelpGen.cpp,v $
   Revision 1.1.1.1  2009/10/09 02:59:40  jack
   no message

   Revision 1.1  2009/09/30 02:42:27  patrick
   (wxWidget) update at 2009/09/30
