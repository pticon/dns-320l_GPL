...
// Patrick.alpha 20090814 begin
GLOBAL(unsigned int tryings, 0);
//GLOBAL(unsigned long previousip, 0U);
GLOBAL0(char previousip[64]);
// Patrick.alpha 20090814 end
GLOBAL(time_t timestamp, 0U);	// alpha.patrick 20100514 ++
