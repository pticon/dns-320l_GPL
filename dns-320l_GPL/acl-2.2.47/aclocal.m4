...
AC_DEFUN([AC_PACKAGE_UTILITIES],
  [ AC_PROG_CC
	...
	AC_PATH_PROG(LIBTOOL, glibtool,, /opt_gccarm/arm-vfp-linux-gnueabi/arm-vfp-linux-gnueabi/bin)
    fi
    if test -z "$LIBTOOL"; then
	AC_PATH_PROG(LIBTOOL, libtool,, /opt_gccarm/arm-vfp-linux-gnueabi/arm-vfp-linux-gnueabi/bin:/usr/local/bin:/usr/freeware/bin)
    fi
    libtool=$LIBTOOL
    AC_SUBST(libtool)
